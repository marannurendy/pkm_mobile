...
export default function ReportLPM(props) {
    ...
    // var link = "http://reportlhtksystem.yakinbisa.id/jasperserver/rest_v2/reports/reports/PKM_Prod/LPM.html?TrxDate="+ tanggal +"&OurBranchID="+ idcabang +"&GroupID="+ kelompokid
