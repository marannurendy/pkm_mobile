                        ...
                        const setRumah = () => {
                            ...
                            return new Promise((resolve, reject) => {
                                if (data.foto_rumah !== null && typeof data.foto_rumah !== 'undefined') {
                                    setTimeout(async () => {
                                        setKey_fotoRumah(data.foto_rumah);
                                        const fotoRumah = data.foto_rumah ? await AsyncStorage.getItem(data.foto_rumah) : '';
                                        if (__DEV__) console.log('fotoRumah :', data.foto_rumah, fotoRumah);
                                        setFotoRumah(fotoRumah);
                                        return resolve('next');
                                    }, 3500);
                                }
                                return resolve('next');
